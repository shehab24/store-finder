import { getBackgroundCSS, getBorderCSS, getColorsCSS, getIconCSS, getMultiShadowCSS, getSeparatorCSS, getSpaceCSS, getTypoCSS } from '../../Components/utils/getCSS';
...
const Style = ({ attributes, clientId }) => {
	...
	const mainSl = `#storefindStoreFinder-${clientId}`;
	const blockSl = `${mainSl} .storefindStoreFinder`;
